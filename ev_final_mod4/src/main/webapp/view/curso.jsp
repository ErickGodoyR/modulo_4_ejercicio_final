...
<div class="container-fluid">
	...
	<h1 class="text-sm-center text-md-center text-lg-center text-xl-center fs-3 text-decoration-underline">LISTA DE CURSOS</h1>
	
	<a href="${pageContext.request.contextPath}/AgregarCursoServlet"
			class="btn btn-primary mb-3">Agregar Curso</a>
